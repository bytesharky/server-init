...
DEFAULT_CONTAINER_NAME="php-8.2"

REMOTE_IMAGE_NAME="ccr.ccs.tencentyun.com/sharky/sharky-php:8.2-alpine"
DEFAULT_IMAGE_NAME="sharky-php:8.2-alpine"
...
cat > /data/docker/php-fpm/php-8.2.conf <<EOF
[global]
daemonize = no
